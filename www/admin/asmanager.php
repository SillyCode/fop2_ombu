...
class AsteriskManager
{
    ...
    function AsteriskManager($config=NULL, $optconfig=array())
    {
        ...
        if(!isset($this->config['asmanager']['username'])) $this->config['asmanager']['username'] = 'astmanager';
        if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 'Xn75CFbVfjRg71v';
    }
