...
uasort($fopsortedbuttons, "naturalsort");
...
<i style='vertical-align:super; top:-5px; color:#333;' class='ttip glyphicon glyphicon-info-sign' data-toggle='popover' data-trigger='hover' data-placement='bottom' data-content='<?php echo __('You can change button labels and privacy options -to prevent the button to be monitored and/or hide the CallerID- among other things. You can also sort the list by dragging elements up and down or using the Sort options in the Actions menu.'); ?>'></i>
</div>
<div class="col-md-8 text-right">


<div class="btn-group">
<button type="button" onclick="toggleAdvanced(); return false;" class="btn btn-default"><i class='glyphicon glyphicon-wrench'></i> <?php echo __('Toggle Advanced Fields');?></button>
</div>
...
//    echo "pages $total_pages, first record $first_record, last record $last_record, current page $page<br>";
    ...
    if($tipocorto=="extension" && $total_pages > 1) {
        ...
        if($page>0) {
            echo "<a class='btn btn-default' href='#' onClick=\"getSection('container_${tipocorto}',$page)\">Previous</a> &nbsp; ";
        }
        if($nextpage-1 < $total_pages) {
            echo "<a class='btn btn-default' href='#' onClick=\"getSection('container_${tipocorto}',$nextpage)\">Next</a>";
        }
        echo "</td></tr>";
    }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class='xcontent'><span class='glyphicon glyphicon-list-alt pull-left' style='padding: 7px 5px; font-size:1.5em;'></span><h3 class='modal-title uploadtitle'><?php echo __('Mass Update via CSV File'); ?></h3></div>
                    </div>
