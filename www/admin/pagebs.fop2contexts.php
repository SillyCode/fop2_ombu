...
<i style='vertical-align:super; top:-5px; color:#333;' class='ttip glyphicon glyphicon-info-sign' data-toggle='popover' data-trigger='hover' data-placement='bottom' data-content='<?php echo __('You can enable or disable FOP2 for particular tenats from this page.'); ?>'></i>
</div>
...
<?php
    ...
    $results = $db->consulta("SELECT * FROM fop2contexts ORDER BY context");
    $cont=0;
