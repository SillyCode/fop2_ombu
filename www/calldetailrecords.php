...
function clickdial($number) {
   ...
   if(strlen($numberstrip)>0) {
       return "<div style='height:1.5em;'><a data-toggle='tooltip' class='clicktodial' data-original-title='click to dial' href='http://www.google.com' onclick='parent.parent.dial(\"$numberstrip\"); return false;'>$number</a></div>";
   } else {
       return $number;
   }
}
